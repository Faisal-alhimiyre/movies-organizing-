(function () {
  ...
  const MESSAGES = {
    en: {
      ...
      "seasons.gapPromptMessage": "You haven't marked earlier episodes in this season as watched. Mark all previous episodes as watched too?",
    ...
    ar: {
      ...
      "seasons.gapPromptMessage": "لم تُعيّن الحلقات الأقدم في هذا الموسم كمشاهَدة. هل تريد تعيين كل الحلقات السابقة كمشاهَدة أيضاً؟",
