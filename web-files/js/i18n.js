(function () {
  ...
  const MESSAGES = {
    en: {
      ...
      "detail.tabSimilar": "Similar shows",
      "detail.similarSectionTitle": "Other movies that you might like",
      ...
      "progress.unmarkSeasonWatched": "Season watched",
      "progress.seasonWatched": "Season watched",
      "progress.seasonUnwatched": "Mark season watched",
      ...
      "seasons.error": "Couldn't load seasons right now.",
      "seasons.errorHint": "Check your connection, then tap Retry.",
      "seasons.unavailable": "Season details unavailable.",
      "seasons.noSeasons": "No seasons available.",
      "seasons.offline": "You're offline — showing saved season data.",
      "seasons.offlineNoCache": "Season data isn't available offline yet.",
      "seasons.offlineNoCacheHint": "Connect to the internet, then tap Retry. Open this title once while online so seasons are saved for next time.",
      ...
      "seasons.episodesError": "Couldn't load episodes right now.",
      "seasons.episodesErrorHint": "Check your connection, then tap Retry.",
      ...
      "seasons.seasonRatingSource": "Season's rating {rating}/10",
      "seasons.yourSeasonRating": "Your season rating {rating}/10",
      "seasons.episodeAvgSuggest": "Use your seasons' average {rating}/10",
      "seasons.episodeAvgRatedMeta": "You rated {rated} of {total}",
      "seasons.episodeAvgRatedMetaShort": "You rated {rated} episodes",
    ...
    ar: {
      ...
      "detail.tabSimilar": "مسلسلات مشابهة",
      "detail.similarSectionTitle": "أفلام أخرى قد تعجبك",
      ...
      "progress.unmarkSeasonWatched": "الموسم مشاهَد",
      "progress.seasonWatched": "الموسم مشاهَد",
      "progress.seasonUnwatched": "تعيين الموسم كمشاهَد",
      ...
      "seasons.error": "تعذّر تحميل المواسم الآن.",
      "seasons.errorHint": "تحقق من اتصالك، ثم اضغط إعادة المحاولة.",
      "seasons.unavailable": "تفاصيل المواسم غير متاحة.",
      "seasons.noSeasons": "لا توجد مواسم متاحة.",
      "seasons.offline": "أنت غير متصل — تُعرض بيانات المواسم المحفوظة.",
      "seasons.offlineNoCache": "بيانات المواسم غير متاحة دون اتصال بعد.",
      "seasons.offlineNoCacheHint": "اتصل بالإنترنت، ثم اضغط إعادة المحاولة. افتح هذا العنوان مرة واحدة وأنت متصل ليُحفظ للمواسم لاحقاً.",
      ...
      "seasons.episodesError": "تعذّر تحميل الحلقات الآن.",
      "seasons.episodesErrorHint": "تحقق من اتصالك، ثم اضغط إعادة المحاولة.",
      ...
      "seasons.seasonRatingSource": "تقييم الموسم {rating}/10",
      "seasons.yourSeasonRating": "تقييمك للموسم {rating}/10",
      "seasons.episodeAvgSuggest": "استخدم متوسط مواسمك {rating}/10",
      "seasons.episodeAvgRatedMeta": "قيّمت {rated} من {total}",
      "seasons.episodeAvgRatedMetaShort": "قيّمت {rated} حلقات",
